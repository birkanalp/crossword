...
1. Read `.claude/context/design-principles.md` for Bulmaca-specific design standards
2. Use Playwright MCP to navigate to **http://localhost:3001** (or the URL provided by the user)
